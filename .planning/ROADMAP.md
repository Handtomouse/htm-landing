...
Plans:
- [ ] 01-01-PLAN.md — Wave 0: Pre-flight scripts (em-dash audit, headless screenshot, image-200 checker) + ArgentPixelCF/`_heroes.js` decisions
- [ ] 01-02-PLAN.md — Wave 1: Extract cases.ts via vm.runInNewContext + migrate 19 case asset folders (DATA-01, DATA-02, POLISH-04)
- [ ] 01-03-PLAN.md — Wave 1: CSS isolation (app/work/portfolio.css scoped under .htm-portfolio) + next/font setup (RENDER-04 foundation)
- [ ] 01-04-PLAN.md — Wave 2: Gallery + case-detail routes with generateStaticParams + 5 components (RENDER-01..04, POLISH-03, POLISH-04)
...
|---|---|---|---|
| 1. v1.0 Portfolio Launch | 0/7 | Planned | - |
